...
import blackandwhite from "@/images/BlackAndWhiteImages/blackandwhite8.jpeg"; // Using alias to refer to src/images/BlackAndWhiteImages
...
const BWPage1 = () => {
  ...
  const handleBuyNow = async () => {
      try {
        ...
        const priceKey = `BW8_${selectedSize}`;
