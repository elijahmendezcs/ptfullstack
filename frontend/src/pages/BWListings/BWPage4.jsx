...
import blackandwhite from "@/images/BlackAndWhiteImages/blackandwhite4.jpg"; // Using alias to refer to src/images/BlackAndWhiteImages
...
const BWPage1 = () => {
  ...
  const handleBuyNow = async () => {
      try {
        ...
        const priceKey = `BW4_${selectedSize}`;
