...
import blackandwhite from "@/images/BlackAndWhiteImages/blackandwhite1.jpg"; // Using alias to refer to src/images/BlackAndWhiteImages
...
const BWPage1 = () => {
  ...
  const handleBuyNow = async () => {
      try {
        ...
        const priceKey = `BW7_${selectedSize}`;
