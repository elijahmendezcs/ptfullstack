...
import blackandwhite from "@/images/BlackAndWhiteImages/blackandwhite11.jpg"; // Using alias to refer to src/images/BlackAndWhiteImages
...
const BWPage1 = () => {
  ...
  const handleBuyNow = async () => {
    try {
      ...
      const priceKey = `BW11_${selectedSize}`;
